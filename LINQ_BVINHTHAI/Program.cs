    ...
    class Program
    {
        static void Main(string[] args)
        {
               ...
               new Khoa
            {
                ...
                {
                    new SinhVien { tenSinhVien = "Bui Quoc Huy", diemTrungBinh = 8.5 },
                    new SinhVien { tenSinhVien = "Bui Vinh Thai", diemTrungBinh = 6.8 },
                ...
                new Khoa
            {
                ...
                DanhSachSinhVien = new List<SinhVien>
                {
                    ...
                    new SinhVien { tenSinhVien = "Duong Van Bao", diemTrungBinh = 8.8 },
                    new SinhVien { tenSinhVien = "Le Quang Bao Cuong", diemTrungBinh = 9.2 }
                }
              },
            };
